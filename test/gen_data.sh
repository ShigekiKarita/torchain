...
featdir=$tmpdir/feat_hires
utils/subset_data_dir.sh --first data/train 10 $featdir
apply-cmvn --norm-means=false --norm-vars=false --utt2spk=ark:$featdir/utt2spk scp:$featdir/cmvn.scp scp:$featdir/feats.scp ark:- | subset-feats --n=10 ark:- ark:- > $outdir/mfcc.ark
